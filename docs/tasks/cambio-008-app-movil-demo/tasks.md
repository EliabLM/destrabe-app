...
- [x] T6 — Scaffold Expo Dev Build
- [x] T7 — Stores + Axios + SecureStorage
- [x] T8 — Navigation tree + App bootstrap
- [x] T9 — Auth OTP screens
- [x] T10 — Onboarding screens
- [x] T11 — Client screens
- [x] T12 — Operator screens
- [x] T13 — Mapbox init + picker + usePolling
- [x] T14 — App setup runbook
- [x] T15 — Regression + tasks complete
